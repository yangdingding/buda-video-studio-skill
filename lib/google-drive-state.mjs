...
export const decisionToStatusEntry = (decision) => ({
  ...
  published_links:
    decision.published_links && typeof decision.published_links === "object" && !Array.isArray(decision.published_links)
      ...
      : {},
  distribution_copy: normalizeDistributionCopy(decision.distribution_copy),
  production_engine: decision.production_engine === "remotion" ? "remotion" : "hyperframes",
  brand_profile: decision.brand_profile === "buda" ? "buda" : "project",
