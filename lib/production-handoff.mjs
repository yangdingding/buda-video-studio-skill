...
3. Invoke $buda-video-delivery in covers mode with brand profile ${brandProfile}. Produce the selected cover languages, required 16:9 exports, and the matching 9:16 Shorts cover variant when Shorts or vertical delivery is selected. If no real screenshot exists yet, create a storyboard/script-driven cover from the approved storyboard/script and mark the cover evidence as script-derived; do not wait for human screen recording.
